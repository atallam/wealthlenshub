...
export default function SetuAAImport({ onClose, onImported, members, api }) {
  ...
  const cardS = { background: "var(--bg-muted)", border: "1px solid var(--border)", borderRadius: 10, padding: "1rem" };
  ...
  const primaryBtn = { ...btnS, background: "#4caf9a", color: "var(--text)" };
  const secondaryBtn = { ...btnS, background: "var(--bg-muted)", color: "var(--text-dim)", border: "1px solid var(--border)" };
  ...
  return (
    <div style={{ ...S, maxWidth: 560, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.2rem" }}>
        <div>
          <div style={{ fontSize: "1.1rem", fontFamily: "'Cormorant Garamond',serif", color: "var(--text)" }}>🔗 Account Aggregator Import</div>
      ...
      {step === "mobile" && (
        <>
          <div style={cardS}>
            <div style={{ fontSize: ".78rem", color: "var(--text)", marginBottom: ".8rem" }}>Enter your mobile number linked to your bank accounts</div>
