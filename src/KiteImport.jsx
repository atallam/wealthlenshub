...
const S = {
  ...
  input:   { width: "100%", padding: ".5rem .7rem", background: "var(--bg-muted)", border: "1px solid var(--border)", borderRadius: 6, color: "var(--text)", fontSize: ".82rem", fontFamily: "'DM Mono', monospace", boxSizing: "border-box" },
      ...
      {step === "reauth" && (
        <div style={S.card}>
          ...
          <div style={{ fontSize: ".72rem", color: "var(--text-muted)", lineHeight: 1.7, marginBottom: ".8rem" }}>
            ...
            &nbsp;&nbsp;&nbsp;e.g. <code style={{ color: "var(--text-muted)", fontSize: ".65rem" }}>…/callback?request_token=<b>PASTE_THIS</b>&status=success</code>
          </div>
